...
{
    public float amplitude = 5f; // How far the letters float
    public float frequency = 2f; // Speed of the float
    public float waveOffset = 0.2f; // Offset between each letter
